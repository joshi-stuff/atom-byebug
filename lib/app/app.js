...
export default class Application {
  ...
  run() {
    ...
    process.on(DebugProcess.EVENT.PROC_STOPPED, () => {this._on_stopped()});
    process.on(DebugProcess.EVENT.DBG_CONNECTED, () => {alert('connected')});
    process.on(DebugProcess.EVENT.DBG_DISCONNECTED, () => {alert('disconnected')});
  ...
  _create_view() {
    ...
    view.on(DebuggerView.EVENT.CLEAR, () => {this.run()});
    view.on(DebuggerView.EVENT.CONFIGURE, () => {this.run()});
